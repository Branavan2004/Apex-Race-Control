...
const channels = [
  { label: "Email", icon: Mail, href: "mailto:branavan@example.com", desc: "Direct radio link" },
  { label: "LinkedIn", icon: Linkedin, href: "https://linkedin.com", desc: "Team network" },
  { label: "GitHub", icon: Github, href: "https://github.com", desc: "Code garage" },
];
